  ...
  return (
    <a
      ...
      className={cn(
        ...
        variant === 'primary' &&
          'border-transparent bg-accent text-on-accent shadow-[0_0_0_0_var(--color-accent-glow)] hover:bg-accent-hover hover:shadow-[0_0_28px_var(--color-accent-glow)] hover:no-underline',
        variant === 'outline' &&
